...
public class IqSoft_API_6_RollBackDebit_Positive_Test extends BaseTest{
    ...
    @Description("Verify RollBack API_s Positive Response Balance Corrections")
    @Severity(SeverityLevel.BLOCKER)
    public void RollBackAPIValidatePositiveResponseBalanceCorrection() {
        ...
        softAssert.assertEquals(afterRollBackDebit, afterCredit ,
                "afterRollBackDebit: "+ afterRollBackDebit + " = afterCredit: " + afterCredit );
